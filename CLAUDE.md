...
9. **メール作成（返信／新規）** - 「このアドレスへ新規メール」で別案件を正しく新規送信し、相手のスレッドを汚さない
10. **SNS 統合（メッセージハブ）** ※後続ステップ - LINE／Instagram／Messenger／WhatsApp の DM・コメントを統合インボックスに集約（クラウド中継経由）。**コア機能の安定後に着手**
11. **多言語対応** - 日本語・英語（将来的に拡張）
12. **マルチアカウント** - 複数のメールアカウント統合管理
